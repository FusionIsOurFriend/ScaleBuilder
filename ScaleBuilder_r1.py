...
for count in range(100) :
    root = getUserInput(message = "Please enter a root note A-G (Press 'x' to escape): ").upper()
    mode = int(getUserInput(message = "Please enter a root note A-G (Press 'x' to escape): "))
